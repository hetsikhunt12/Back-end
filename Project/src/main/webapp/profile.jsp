        ...
        %>
          <form class="form-contact contact_form"  method="post" action="UserController" enctype="multipart/form-data">
            <div class="row">
              ...
              <div class="col-12">
                <div class="form-group">
                    <textarea class="form-control w-100" name="address" id="message" cols="30" rows="9" placeholder="Enter Address"><%=u.getAddress()%></textarea>
                </div>
              </div>
              
              <div class="col-12">
                <div class="form-group">
                    <img src="profile_picture/<%=u.getProfile_picture()%>" style="eidth: 100px;height: 100px; border-radius: 50%">
                </div>
              </div>
              <div class="col-12">
                <div class="form-group">
