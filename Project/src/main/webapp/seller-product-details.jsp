          ...
          <div class="col-lg-5 offset-lg-1">
            <div class="s_product_text">
              ...
              <ul class="list">
                <li>
                  <a class="active" href="#">
                    <span>Category</span><%=p.getProduct_catagory() %></a
                  >
                </li>
              ...
              <div class="card_area">
                <a class="main_btn" href="seller-edit-product.jsp?pid=<%=p.getPid()%>">EDIT</a>
                <a class="main_btn" href="seller-delete-product.jsp?pid=<%=p.getPid()%>">DELETE</a>
