...
<html lang="en">
  ...
  <section class="section_gap">
    <div class="container">
      <div class="row">
        <div class="col-12">
          <h2 class="contact-title">User Signup</h2>
        </div>
        ...
        %>
          <form class="form-contact contact_form"  method="post" action="UserController" enctype="multipart/form-data">
            ...
            <div class="col-sm-12">
              ...
              <div class="col-12">
                <div class="form-group">
                    <textarea class="form-control w-100" name="address" id="message" cols="30" rows="9" placeholder="Enter Address"></textarea>
                </div>
              </div>
              <div class="col-12">
                <div class="form-group">
             ...
             <div class="col-sm-6">
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  <input class="form-control" name="cpassword" id="name" type="password" placeholder="Enter confirm passsword">
                </div>
              </div>
